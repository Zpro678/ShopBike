        ...
        <form method="POST" action="{{ route('admin.addCategories') }}">
            ...
            <div class="form-group mb-2">
                ...
                <input type="text" name="loai_danh_muc" class="form-control" placeholder="Nhập loại danh mục" required
                    oninvalid="this.setCustomValidity('Vui lòng nhập loại danh mục')"
                    oninput="this.setCustomValidity('')">
            </div>
            <div class="form-group mb-2">
                <label>Mô tả</label>
                <textarea name="mo_ta" class="form-control" rows="3" placeholder="Mô tả danh mục" required
                    oninvalid="this.setCustomValidity('Vui lòng nhập mô tả danh mục')"
