<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{route ('admin.tables') }}"><i class="fa fa-table fa-fw"></i> Tables</a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route ('admin.panels_wells') }}">Panels and Wells</a>
                                </li>
                                <li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="{{route ('admin.blank') }}">Blank Page</a>
                                </li>
                                <li>
