		...
		<div class="header">
			...
			<div class="top-nav">
				...
				<ul class="nav">
					...
					<li class="dropdown1"><a class="scroll" href="{{route('user.parts.parts')}}">PARTS</a>
						<ul class="dropdown2">
					...
					<li class="dropdown1"><a class="scroll" href="{{route('user.accessories.accessories')}}">ACCESSORIES</a>
						<ul class="dropdown2">
					...
					<li class="dropdown1"><a class="scroll" href="{{route('user.404.404')}}">EXTRAS</a>
						<ul class="dropdown2">
					...
					@if (Auth::guard('khachhang')->check())
						...
						<li class="dropdown1">
							<a href="#">Xin chào, {{ Auth::guard('khachhang')->user()->HoTen }}!</a>
						</li>
