...
@section('title','Bike Shop a Ecommerce Category Flat Bootstarp Responsive Website Template| Cart :: w3layouts')
@section('main')
<!--/banner-->
<div class="cart">
	 <div class="container">
		 ...
		 <div class="col-md-9 cart-items">
			 ...
			 <div class="cart-header">
				 ...
				 <div class="cart-sec">
						<div class="cart-item cyc">
							 <img src="@theme_user('images/bik6.jpg')"/>
						</div>
			 ...
			 <div class="cart-header2">
				 <div class="close2"> </div>
				  <div class="cart-sec">
						<div class="cart-item">
							 <img src="@theme_user('images/a3.png')"/>
						</div>
					   <div class="cart-item-info">
