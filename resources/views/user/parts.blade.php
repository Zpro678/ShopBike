...
@section('title','Bike Shop a Ecommerce Category Flat Bootstarp Responsive Website Template| Parts :: w3layouts')
@section('main')
<!--/banner-->
<div class="parts">
	 <div class="container">
		      ...
		      <div class="bike-parts">
				 ...
				 <div class="bike-apparels">
					 ...
					 <div class="parts4">
						 ...
						 <a href="{{route('user.single')}}"><div class="part-sec bottom-line none1">					 
