...
@section('title','Bike Shop a Ecommerce Category Flat Bootstarp Responsive Website Template| Single :: w3layouts')
@section('main')
<!--/banner-->
<div class="product">
	 <div class="container">
			 ...
			 <div class="content-bar">
				 <div class="single-page">
					 ...
					 <!--Include the Etalage files-->
						<link rel="stylesheet" href="@theme_user('css/etalage.css')">
						<script src="@theme_user('js/jquery.etalage.min.js')"></script>
				<script>
						  ...
						  <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="@theme_user('images/m1.jpg')" class="img-responsive" />
									<img class="etalage_source_image" src="@theme_user('images/m1.jpg')" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="@theme_user('images/m2.jpg')" class="img-responsive" />
								<img class="etalage_source_image" src="@theme_user('images/m2.jpg')" class="img-responsive" title="" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="@theme_user('images/m3.jpg')" class="img-responsive"  />
								<img class="etalage_source_image" src="@theme_user('images/m3.jpg')"class="img-responsive"  />
							</li>
						    <li>
								<img class="etalage_thumb_image" src="@theme_user('images/m4.jpg')" class="img-responsive"  />
								<img class="etalage_source_image" src="@theme_user('images/m4.jpg')"class="img-responsive"  />
							</li>
						</ul>
						</div>
					 </div>
