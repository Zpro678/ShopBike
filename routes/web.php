...
Route::prefix('/manager')->name('admin.')->group(function () {
    Route::get('/loginAdmin', [AdminController::class, 'loginAdminIndex'])->name('loginAdmin');
    Route::post('/loginAdmin', [AdminController::class, 'loginAdmin'])->name('loginAdmin.store');
});
